...
public class PoseEstimatorSubsystem extends SubsystemBase {
    ...
    private final SwerveModulePosition[] defaultModulePositions = new SwerveModulePosition[] {
            new SwerveModulePosition(), new SwerveModulePosition(), new SwerveModulePosition(),
            new SwerveModulePosition() };
    private final SwerveModulePosition[] previousModulePositions = new SwerveModulePosition[] {
            new SwerveModulePosition(), new SwerveModulePosition(), new SwerveModulePosition(),
            new SwerveModulePosition() };
     ...
     * 
     */
    public PoseEstimatorSubsystem(Supplier<SwerveModulePosition[]> modulePositionSupplier,
    ...
    public void periodic() {
        ...
        if (!isConnected()) {
            ...
            for (int i = 0; i < moduleDeltas.length; i++) {
                ...
                moduleDeltas[i] = new SwerveModulePosition(current.distanceMeters - previous.distanceMeters,
                        current.angle);
        ...
        if (!isConnected()) {
            double velocityMetersPerSecond = Conversions.distanceBetween(estimatedPoseWithoutGyro,
    ...
    // this.estimatedPoseWithoutGyro = new Pose2d(state.poseMeters.getTranslation(),

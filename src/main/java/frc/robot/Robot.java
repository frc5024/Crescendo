...
public class Robot extends LoggedRobot {
    ...
    public void robotInit() {
        // Set AdvantageKit meta data and start logger
        Logger.recordMetadata("ProjectName", "2024 Crescendo");
        Logger.recordMetadata("Robot", "MainBot");
        Logger.recordMetadata("TuningMode", Boolean.toString(AdvantageKit.TUNING_MODE));
    ...
    public void robotPeriodic() {
        ...
        // visionModule.periodic(); //I JUST COMMENTED THIS OUT - JOSH
    }
